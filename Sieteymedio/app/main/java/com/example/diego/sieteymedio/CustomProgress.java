...
import com.example.diego.sieteymedio.R;
...
public class CustomProgress extends android.support.v7.widget.AppCompatTextView {
    ...
    private void setDefaultValue() {
        // default color
        progressColor = getResources().getColor(R.color.colorAccent);
        progressBackgroundColor = getResources().getColor(R.color.colorAccent);
    }
